...
element_of_array="Sketch to be Drawn- "+element_of_array;
...
console.log(results);
drawn_sketch = results[0].results;
document.getElementById('label').innerHTML='Your Sketch:'+drawn_sketch;
document.getElementById('label').innerHTML='Your Sketch:'+Math.round(results[0].confidence) * 100+"%";
}
